...
18. When a feature claims to replace section-anchor browsing with graph/node-first navigation, explicitly validate every primary hero CTA and shared-chrome CTA destination so no legacy anchor-scroll path remains in the main shell.
